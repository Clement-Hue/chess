...
public:
	...
	bool is_same_rank(const int8_t value) const noexcept { return this->get_rank() == value / NB_COLUMNS; }
	bool is_same_file(const int8_t value) const noexcept { return this->get_file() == value % NB_COLUMNS; }
