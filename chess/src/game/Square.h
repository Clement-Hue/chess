...
public:
	...
	bool is_same_rank(const uint8_t rank) const noexcept { return this->get_rank() == rank / NB_SQUARES_BY_ROW; }
	bool is_same_file(const uint8_t file) const noexcept { return this->get_file() == file % NB_SQUARES_BY_ROW; }
