...
public:
	...
	bool is_same_rank(const uint8_t value) const noexcept { return this->get_rank() == value / NB_SQUARES_BY_ROW; }
	bool is_same_file(const uint8_t value) const noexcept { return this->get_file() == value % NB_SQUARES_BY_ROW; }
